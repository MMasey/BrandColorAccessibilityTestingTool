...
- Color input supporting hex, RGB, and HSL formats
- Contrast grid showing all color pair combinations
...
## [0.0.1] - Phase 1 (In Progress)

Initial development of core contrast checking functionality.
