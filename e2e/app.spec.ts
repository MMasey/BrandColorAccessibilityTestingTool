...
test.describe('Brand Color Accessibility Tool', () => {
  ...
  test('skip link should navigate to main content when activated', async ({ page }) => {
    ...
    const mainContent = page.locator('bca-app-shell').locator('main');
  ...
  test('should have proper landmark regions', async ({ page }) => {
    ...
    const main = page.locator('bca-app-shell').locator('main');
...
test.describe('Color Palette Functionality', () => {
  ...
  test('should add a colour to the palette', async ({ page }) => {
    ...
    const colorSwatch = page.locator('bca-color-palette').locator('bca-color-swatch');
...
test.describe('Keyboard Navigation', () => {
  ...
  test('should allow keyboard operation of theme switcher', async ({ page }) => {
    ...
    for (let i = 0; i < 20; i++) {
      const focused = await page.evaluate(() => {
        ...
        return active?.closest('bca-theme-switcher') !== null;
      });
      if (focused) break;
      await page.keyboard.press('Tab');
    }
  ...
  test('contrast grid should be keyboard focusable and support arrow keys', async ({ page }) => {
    ...
    const gridWrapper = page.locator('bca-contrast-grid .grid-wrapper');
...
test.describe('Accessibility Audit (axe-core)', () => {
  ...
  test('should have no accessibility violations in dark mode', async ({ page }) => {
    ...
    const darkOption = page.locator('bca-theme-switcher').locator('label', { hasText: 'Dark' });
  ...
  test('should have no accessibility violations in high contrast mode', async ({ page }) => {
    ...
    const highContrastOption = page.locator('bca-theme-switcher').locator('label', { hasText: 'High' });
...
test.describe('Responsive Design', () => {
  test('should render correctly on mobile', async ({ page }) => {
    ...
    const themeSwitcher = page.locator('bca-theme-switcher');
  ...
  test('contrast grid should scroll horizontally on mobile with many colors', async ({ page }) => {
    ...
    const gridWrapper = page.locator('bca-contrast-grid').locator('.grid-wrapper');
...
test.describe('Grid Filters', () => {
  ...
  test('should toggle AAA filter on/off', async ({ page }) => {
    const gridFilters = page.locator('bca-grid-filters');
  ...
  test('should filter grid cells when filters are toggled', async ({ page }) => {
    ...
    const initialCells = contrastGrid.locator('bca-contrast-cell');
    ...
    const filteredCells = contrastGrid.locator('bca-contrast-cell[filtered]');
...
test.describe('URL State Management (Progressive Enhancement)', () => {
  test('should load colors from URL parameters', async ({ page }) => {
    ...
    const swatches = page.locator('bca-color-swatch');
